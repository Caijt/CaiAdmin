...
using CaiAdmin.WebApi.AuthenticationSchemes.ApiFail;
using CaiAdmin.WebApi.AuthorizationPolicies;
using CaiAdmin.WebApi.AuthorizationPolicies.ApiPermission;
using CaiAdmin.WebApi.Controllers;
using CaiAdmin.WebApi.Conventions;
using CaiAdmin.WebApi.Middlewares;
...
[assembly: DependOn(typeof(CaiAdmin.Service.Startup))]
namespace CaiAdmin.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<CityoceanOption>(Configuration.GetSection("Cityocean"));
            ...
            {
                //添加全局授权过滤器
                //o.Filters.Add(new AuthorizeFilter());添加这个会导致权限校验两次
            ...
            if (!string.IsNullOrWhiteSpace(redisConnectionString))
            {
                ...
                var redis = new RedisCacheHelper(redisConnectionString);

...
namespace CaiAdmin.WebApi.Middlewares
{
    public class ApiExceptionMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, ILoggerFactory loggerFactory)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (ex is ApiFailException || ex.InnerException is ApiFailException)
                {
                    var apiException = ex as ApiFailException;
                    if (apiException == null)
                    {
                        apiException = ex.InnerException as ApiFailException;
                    }

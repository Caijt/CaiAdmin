...
namespace CaiAdmin.Service.Fcm
{
    public class ShipmentService
    {
        ...
        public ShipmentService(CityOceanRepository cityOceanRepository, CityOceanApiService cityOceanApiService)
        {
        ...
        /// <returns></returns>        
        public async Task<PageListDto<ShipmentDto>> GetPageListAsync(ShipmentQueryDto queryDto)
        {
            ...
            var result = new PageListDto<ShipmentDto>();
            RefAsync<int> total = 0;
            var data = await _cityOceanRepository.Context
                .SqlQueryable<ShipmentDto>(@"Select 
                    s.Id,
                    s.ShipmentNo,
                    s.CreationTime,                    
                    (Select top 1 CName From CO_SSO.dbo.Users u where u.Id = s.CreatorUserId) as CreatorUserName
                 From CO_FCM.dbo.Shipments s")

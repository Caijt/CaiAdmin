...
{
    public class ApiService_bak : EntityService<ApiDto, ApiDto, ApiDto, ApiQueryDto, Api, int>
    {
        public ApiService_bak(AppDbContext appDbContext, IMapper mapper, IEnumerable<IEntityHandler<Api>> entityHandlers, IEnumerable<IQueryFilter<Api>> queryFilters) : base(appDbContext, mapper, entityHandlers, queryFilters)
        {
        }
